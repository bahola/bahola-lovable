...
export const healthConcernsData: HealthConcern[] = [
  ...
  // Immune Boosters - All 8 conditions
  {
    id: 'recurrent-colds-cough',
    name: 'Recurrent Colds / Cough',
    description: 'Natural support for frequent colds and persistent coughs to strengthen immunity.',
    category: 'immune-boosters',
    icon: '🤧',
    image: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=400&h=300&fit=crop',
    searchVolume: 35000,
    commonRemedies: ['Arsenicum Album', 'Hepar Sulph', 'Silicea', 'Calcarea Carbonica'],
    keywords: ['recurrent colds', 'frequent cough', 'weak immunity', 'cold prevention'],
    lastUpdated: '2024-01-15',
    trending: true,
  },
  {
    ...
    description: 'Homeopathic support for those prone to repeated infections and low immunity.',
    category: 'immune-boosters',
    icon: '🦠',
    image: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=400&h=300&fit=crop',
    searchVolume: 28000,
    commonRemedies: ['Echinacea', 'Arsenicum Album', 'Phosphorus', 'Sulphur'],
    keywords: ['frequent infections', 'repeated illness', 'immune deficiency', 'infection prevention'],
    lastUpdated: '2024-01-15',
  },
  {
    id: 'low-energy-levels',
    name: 'Low Energy Levels',
    description: 'Natural remedies to boost energy levels and combat persistent fatigue.',
    category: 'immune-boosters',
    icon: '⚡',
    image: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=400&h=300&fit=crop',
    searchVolume: 42000,
    commonRemedies: ['Arsenicum Album', 'Phosphoric Acid', 'China', 'Carbo Vegetabilis'],
    keywords: ['low energy', 'fatigue', 'weakness', 'energy boost'],
    lastUpdated: '2024-01-15',
    trending: true,
  },
  {
    ...
    description: 'Support for faster recovery and regaining strength after illness.',
    category: 'immune-boosters',
    icon: '🏥',
    image: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=400&h=300&fit=crop',
    searchVolume: 25000,
    commonRemedies: ['China', 'Arsenicum Album', 'Phosphorus', 'Calcarea Carbonica'],
    keywords: ['post illness recovery', 'convalescence', 'weakness after illness', 'recovery support'],
    lastUpdated: '2024-01-15',
  },
  {
    id: 'general-weakness',
    name: 'General Weakness',
    description: 'Natural support for overall weakness and debility to restore vitality.',
    category: 'immune-boosters',
    icon: '💪',
    image: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=400&h=300&fit=crop',
    searchVolume: 32000,
    commonRemedies: ['China', 'Carbo Vegetabilis', 'Arsenicum Album', 'Phosphoric Acid'],
    keywords: ['general weakness', 'debility', 'lack of strength', 'vitality'],
    lastUpdated: '2024-01-15',
  },
  {
    id: 'convalescence-remedies',
    name: 'Convalescence Remedies',
    description: 'Specialized remedies for the recovery period after surgery or serious illness.',
    category: 'immune-boosters',
    icon: '🌱',
    image: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=400&h=300&fit=crop',
    searchVolume: 18000,
    commonRemedies: ['China', 'Arnica Montana', 'Calcarea Phosphorica', 'Silicea'],
    keywords: ['convalescence', 'recovery remedies', 'post surgery', 'rehabilitation'],
    lastUpdated: '2024-01-15',
  },
  {
    id: 'childrens-immunity-drops',
    name: 'Children\'s Immunity Drops',
    description: 'Safe and gentle immunity support specifically formulated for children.',
    category: 'immune-boosters',
    icon: '👶',
    image: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=400&h=300&fit=crop',
    searchVolume: 30000,
    commonRemedies: ['Calcarea Carbonica', 'Sulphur', 'Silicea', 'Arsenicum Album'],
    keywords: ['children immunity', 'kids immune support', 'pediatric immunity', 'child health'],
    lastUpdated: '2024-01-15',
  },
  {
    id: 'elderly-immune-support',
    name: 'Elderly Immune Support',
    description: 'Gentle immune system support tailored for elderly individuals and age-related immunity decline.',
    category: 'immune-boosters',
    icon: '👴',
    image: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=400&h=300&fit=crop',
    searchVolume: 22000,
    commonRemedies: ['Arsenicum Album', 'Carbo Vegetabilis', 'Baryta Carbonica', 'Silicea'],
    keywords: ['elderly immunity', 'senior immune support', 'age-related immunity', 'geriatric health'],
    lastUpdated: '2024-01-15',
  },
