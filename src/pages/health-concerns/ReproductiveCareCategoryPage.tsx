        ...
        <main className="flex-grow">
          ...
          <div className="container mx-auto px-4 py-8 max-w-6xl">
            <div className="bg-card rounded-lg shadow-sm border border-border p-6 mb-8">
              <h2 className="text-2xl font-bold mb-4 text-foreground">Understanding Homeopathic Reproductive Care</h2>
              <div className="prose prose-sm max-w-none text-muted-foreground">
                <p className="mb-3">
                  This comprehensive guide provides detailed homeopathic treatment protocols for reproductive health and hormonal wellness. 
                ...
                <ul className="list-disc list-inside space-y-2 mb-4">
                  ...
                  <li><strong className="text-foreground">Biochemic Remedies:</strong> Tissue salts that support reproductive and hormonal health</li>
                  <li><strong className="text-foreground">Bio-Combinations:</strong> Pre-formulated combinations for convenience</li>
                  <li><strong className="text-foreground">Bahola Specialty Products:</strong> Ready-to-use reproductive health formulations</li>
                </ul>
                <p className="text-sm italic border-l-4 border-primary pl-4 py-2 bg-primary/5 rounded">
                  <strong>Important:</strong> Reproductive health concerns require proper medical evaluation and diagnosis. 
                  These remedies are supportive and work best alongside appropriate medical care, healthy lifestyle, and stress management. 
                  For fertility issues, recurrent miscarriages, or persistent symptoms, consult with qualified healthcare providers. 
