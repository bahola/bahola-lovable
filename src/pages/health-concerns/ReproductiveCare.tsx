...
const ReproductiveCare = () => {
  const [searchQuery, setSearchQuery] = useState('');
  const [sortBy, setSortBy] = useState('popular');
  const [viewMode, setViewMode] = useState<'grid' | 'list'>('grid');

  const categoryName = 'Reproductive Care';
        ...
        <div className="bg-bahola-blue-50 py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-bahola-neutral-600 max-w-3xl mx-auto">
              Natural homeopathic support for reproductive health and fertility
            </p>
          </div>
        </div>
        ...
        <div className="bg-gray-50 px-4 py-8">
          <div className="container mx-auto">
            <HealthConcernsBreadcrumb 
              ...
              categoryPath="/health-concerns/reproductive-care"
            />
...
export default ReproductiveCare;
