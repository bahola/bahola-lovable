...
import { skinCareTreatments } from '@/data/health-concerns/skinCareTreatments';
import { TreatmentTable } from '@/components/health-concerns/TreatmentTable';
import { SEO } from '@/components/SEO';

const SkinCareCategoryPage = () => {
  return (
    <>
      <SEO
        title="Skin Care Treatment Guide - Natural Solutions for Acne, Eczema & Skin Conditions"
        description="Comprehensive homeopathic treatment guide for acne, eczema, psoriasis, warts, pigmentation disorders, and skin health with detailed remedies and potencies."
        keywords={[
          'skin care homeopathy',
          'acne treatment',
          'eczema remedies',
          'psoriasis treatment',
          'warts removal',
          ...
          'skin allergy relief',
          'wound healing',
          'biochemic remedies skin health',
          'natural skin care'
        ]}
      />
        ...
        <main className="flex-grow">
          <div className="container mx-auto px-4 py-6">
            <HealthConcernsBreadcrumb 
              ...
              categoryPath="/diseases-conditions/skin-care"
            />
          </div>
          ...
          <div className="bg-gradient-to-br from-primary/10 via-primary/5 to-background py-12 md:py-16">
            <div className="container mx-auto px-4 max-w-6xl">
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4">
                Complete Skin Care Treatment Guide
              </h1>
              <p className="text-lg text-muted-foreground max-w-3xl">
                Natural homeopathic treatment protocols for acne, eczema, psoriasis, pigmentation, and skin wellness. 
          ...
          <div className="bg-card border-y border-border sticky top-0 z-10 shadow-sm">
            <div className="container mx-auto px-4 py-4 max-w-6xl">
              ...
              <div className="flex flex-wrap gap-2">
                {skinCareTreatments.map((treatment, idx) => {
          ...
          <div className="container mx-auto px-4 py-8 max-w-6xl">
            <div className="bg-card rounded-lg shadow-sm border border-border p-6 mb-8">
              <h2 className="text-2xl font-bold mb-4 text-foreground">Understanding Homeopathic Skin Care</h2>
              <div className="prose prose-sm max-w-none text-muted-foreground">
                <p className="mb-3">
                  This comprehensive guide provides detailed homeopathic treatment protocols for skin health and dermatological wellness. 
                ...
                <ul className="list-disc list-inside space-y-2 mb-4">
                  ...
                  <li><strong className="text-foreground">Biochemic Remedies:</strong> Tissue salts that support skin health</li>
                  <li><strong className="text-foreground">Bio-Combinations:</strong> Pre-formulated combinations for convenience</li>
                  <li><strong className="text-foreground">Bahola Specialty Products:</strong> Ready-to-use skin care formulations</li>
                </ul>
                <p className="text-sm italic border-l-4 border-primary pl-4 py-2 bg-primary/5 rounded">
                  <strong>Important:</strong> Skin conditions require proper medical evaluation and diagnosis. 
                  These remedies are supportive and work best alongside appropriate medical care, healthy lifestyle, and proper skin hygiene. 
                  For severe skin conditions, persistent symptoms, or suspected infections, consult with qualified healthcare providers. 
...
export default SkinCareCategoryPage;
