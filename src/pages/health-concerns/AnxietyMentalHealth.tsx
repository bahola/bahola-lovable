...
const AnxietyMentalHealth = () => {
  const [searchQuery, setSearchQuery] = useState('');
  const [sortBy, setSortBy] = useState('popular');
  const [viewMode, setViewMode] = useState<'grid' | 'list'>('grid');

  const categoryName = 'Anxiety & Mental Health';
        ...
        <div className="bg-bahola-blue-50 py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-bahola-neutral-600 max-w-3xl mx-auto">
              Natural homeopathic support for anxiety, stress, and mental wellness
            </p>
          </div>
        </div>
...
export default AnxietyMentalHealth;
