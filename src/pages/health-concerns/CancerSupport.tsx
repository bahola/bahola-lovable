        ...
        <div className="bg-bahola-blue-50 py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-bahola-neutral-600 max-w-3xl mx-auto">
              Supportive homeopathic care during cancer treatment and recovery
            </p>
          </div>
        </div>
        ...
        <div className="bg-gray-50 px-4 py-8">
          <div className="container mx-auto">
            <HealthConcernsBreadcrumb 
              categoryName="Cancer Support"
              categoryPath="/health-concerns/cancer-support"
            />
