            ...
            <div className="flex gap-8 relative">
              ...
              <div className="flex-1 min-w-0">
                <div className="bg-card rounded-lg shadow-sm border border-border p-6 mb-8">
                  <h2 className="text-2xl font-bold mb-4 text-foreground">Understanding Homeopathic Women's Health</h2>
                  <div className="prose prose-sm max-w-none text-muted-foreground">
                    ...
                    <ul className="list-disc list-inside space-y-2 mb-4">
                      ...
                      <li><strong className="text-foreground">Biochemic Remedies:</strong> Tissue salts that support women's wellness</li>
