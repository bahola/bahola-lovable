...
import { womensHealthTreatments } from '@/data/health-concerns/womensHealthTreatments';
import { TreatmentTable } from '@/components/health-concerns/TreatmentTable';
import { SEO } from '@/components/SEO';

const WomensHealthCategoryPage = () => {
  return (
    <>
      <SEO
        title="Women's Health Treatment Guide - Natural Hormonal & Reproductive Solutions"
        description="Comprehensive homeopathic treatment guide for women's health conditions including menstrual cramps, PMS, menopause, leucorrhoea, and PCOS with detailed remedies and potencies."
        keywords={[
          ...
          'dysmenorrhoea remedies',
          'hormonal balance',
          'biochemic remedies women\'s health',
        ...
        <main className="flex-grow">
          <div className="container mx-auto px-4 py-6">
            <HealthConcernsBreadcrumb 
              ...
              categoryPath="/diseases-conditions/womens-health"
            />
          </div>
          ...
          <div className="bg-gradient-to-br from-primary/10 via-primary/5 to-background py-12 md:py-16">
            <div className="container mx-auto px-4 max-w-6xl">
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4">
                Complete Women's Health Treatment Guide
              </h1>
              <p className="text-lg text-muted-foreground max-w-3xl">
                Natural homeopathic treatment protocols for women's health conditions. 
          ...
          <div className="bg-card border-y border-border sticky top-0 z-10 shadow-sm">
            <div className="container mx-auto px-4 py-4 max-w-6xl">
              ...
              <div className="flex flex-wrap gap-2">
                {womensHealthTreatments.map((treatment, idx) => {
          ...
          <div className="container mx-auto px-4 py-8 max-w-6xl">
            <div className="bg-card rounded-lg shadow-sm border border-border p-6 mb-8">
              <h2 className="text-2xl font-bold mb-4 text-foreground">Understanding Homeopathic Women's Health Care</h2>
              <div className="prose prose-sm max-w-none text-muted-foreground">
                <p className="mb-3">
                  This comprehensive guide provides detailed homeopathic treatment protocols for women's health conditions. 
                ...
                <ul className="list-disc list-inside space-y-2 mb-4">
                  ...
                  <li><strong className="text-foreground">Biochemic Remedies:</strong> Tissue salts that support women's health</li>
                  <li><strong className="text-foreground">Bio-Combinations:</strong> Pre-formulated combinations for convenience</li>
                  <li><strong className="text-foreground">Bahola Specialty Products:</strong> Ready-to-use women's health formulations</li>
                </ul>
...
export default WomensHealthCategoryPage;
