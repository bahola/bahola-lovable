...
const LifestyleCare = () => {
  ...
  const categoryName = 'Lifestyle Care';
        ...
        <div className="bg-bahola-blue-50 py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-bahola-neutral-600 max-w-3xl mx-auto">
              Homeopathic support for modern lifestyle challenges and wellness
            </p>
          </div>
        </div>
        ...
        <div className="bg-gray-50 px-4 py-8">
          <div className="container mx-auto">
            <HealthConcernsBreadcrumb 
              ...
              categoryPath="/health-concerns/lifestyle-care"
            />
