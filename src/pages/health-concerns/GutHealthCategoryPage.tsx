...
import { gutHealthTreatments } from '@/data/health-concerns/gutHealthTreatments';
...
const GutHealthCategoryPage = () => {
  return (
    <>
      <SEO
        title="Gut Health Treatment Guide - Digestive & Gastrointestinal Solutions"
        description="Comprehensive homeopathic treatment guide for gut health conditions including acidity, constipation, diarrhoea, fatty liver, and IBS with detailed remedies and potencies."
        keywords={[
          ...
          'liver congestion treatment',
          'biochemic remedies gut health',
          ...
          <div className="bg-gradient-to-br from-primary/10 via-primary/5 to-background py-12 md:py-16">
            <div className="container mx-auto px-4 max-w-6xl">
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4">
                Complete Gut Health Treatment Guide
              </h1>
              <p className="text-lg text-muted-foreground max-w-3xl">
                Natural homeopathic treatment protocols for digestive and gastrointestinal conditions. 
            ...
            <div className="flex gap-8 relative">
              ...
              <aside className="hidden lg:block w-64 shrink-0">
                <div className="sticky top-24 bg-card border border-border rounded-lg p-4 max-h-[calc(100vh-7rem)] overflow-y-auto shadow-sm">
                  ...
                  <nav className="space-y-1">
                    {gutHealthTreatments.map((treatment, idx) => {
              ...
              <div className="flex-1 min-w-0">
                <div className="bg-card rounded-lg shadow-sm border border-border p-6 mb-8">
                  <h2 className="text-2xl font-bold mb-4 text-foreground">Understanding Homeopathic Gut Health Treatment</h2>
                  <div className="prose prose-sm max-w-none text-muted-foreground">
                    <p className="mb-3">
                      This comprehensive guide provides detailed homeopathic treatment protocols for digestive and gastrointestinal conditions. 
                    ...
                    <ul className="list-disc list-inside space-y-2 mb-4">
                      ...
                      <li><strong className="text-foreground">Biochemic Remedies:</strong> Tissue salts that support digestive health</li>
                      <li><strong className="text-foreground">Bio-Combinations:</strong> Pre-formulated combinations for convenience</li>
                      <li><strong className="text-foreground">Bahola Specialty Products:</strong> Ready-to-use gut health formulations</li>
                    </ul>
