            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6">
                <div className="space-y-4">
                  <label 
                    className={`w-full border rounded-lg p-4 cursor-pointer text-left block ${paymentMethod === 'cod' ? 'border-bahola-blue-500 bg-bahola-blue-50' : 'border-gray-300'}`}
                  >
                  ...
                  <label 
                    className={`w-full border rounded-lg p-4 cursor-pointer text-left block ${paymentMethod === 'razorpay' ? 'border-bahola-blue-500 bg-bahola-blue-50' : 'border-gray-300'}`}
                  >
                    <div className="flex items-center">
                      <input 
                        type="radio" 
