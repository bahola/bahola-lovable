...
export const SWELL_SUBCATEGORY_MAP: Record<string, Record<string, string>> = {
  'mother-tinctures': {
    'a': 'mother-tinctures-mt-a',
    'b': 'mother-tinctures-mt-b',
    'c': 'mother-tinctures-mt-c',
    'd': 'mother-tinctures-mt-d',
    'e': 'mother-tinctures-mt-e',
    'f': 'mother-tinctures-mt-f',
    'g': 'mother-tinctures-mt-g',
    'h': 'mother-tinctures-mt-h',
    'i': 'mother-tinctures-mt-i',
    'j': 'mother-tinctures-mt-j',
    'k': 'mother-tinctures-mt-k',
    'l': 'mother-tinctures-mt-l',
    'm': 'mother-tinctures-mt-m',
    'n': 'mother-tinctures-mt-n',
    'o': 'mother-tinctures-mt-o',
    'p': 'mother-tinctures-mt-p',
    'q': 'mother-tinctures-mt-q',
    'r': 'mother-tinctures-mt-r',
    's': 'mother-tinctures-mt-s',
    't': 'mother-tinctures-mt-t',
    'u': 'mother-tinctures-mt-u',
    'v': 'mother-tinctures-mt-v',
    'w': 'mother-tinctures-mt-w',
    'x': 'mother-tinctures-mt-x',
    'y': 'mother-tinctures-mt-y',
    'z': 'mother-tinctures-mt-z',
  },
  'dilutions': {
    'a': 'homeopathic-dilutions-dil-a',
    'b': 'homeopathic-dilutions-dil-b',
    'c': 'homeopathic-dilutions-dil-c',
    'd': 'homeopathic-dilutions-dil-d',
    'e': 'homeopathic-dilutions-dil-e',
    'f': 'homeopathic-dilutions-dil-f',
    'g': 'homeopathic-dilutions-dil-g',
    'h': 'homeopathic-dilutions-dil-h',
    'i': 'homeopathic-dilutions-dil-i',
    'j': 'homeopathic-dilutions-dil-j',
    'k': 'homeopathic-dilutions-dil-k',
    'l': 'homeopathic-dilutions-dil-l',
    'm': 'homeopathic-dilutions-dil-m',
    'n': 'homeopathic-dilutions-dil-n',
    'o': 'homeopathic-dilutions-dil-o',
    'p': 'homeopathic-dilutions-dil-p',
    'q': 'homeopathic-dilutions-dil-q',
    'r': 'homeopathic-dilutions-dil-r',
    's': 'homeopathic-dilutions-dil-s',
    't': 'homeopathic-dilutions-dil-t',
    'u': 'homeopathic-dilutions-dil-u',
    'v': 'homeopathic-dilutions-dil-v',
    'w': 'homeopathic-dilutions-dil-w',
    'x': 'homeopathic-dilutions-dil-x',
    'y': 'homeopathic-dilutions-dil-y',
    'z': 'homeopathic-dilutions-dil-z',
  },
};
