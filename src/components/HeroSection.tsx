...
export const HeroSection = () => {
  return (
    <div className="relative overflow-hidden cloud-bg w-full">
      <div className="container mx-auto px-4 py-16 md:py-24">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="max-w-md mx-auto mb-10 relative">
            ...
            <button className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-bahola-blue-500 text-white px-4 py-2 rounded-full hover:bg-bahola-blue-600 transition-colors">
              Search
            </button>
          </div>
          
          <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-6">
            <Button className="px-8 py-6 rounded-lg bg-bahola-blue-500 text-white hover:bg-bahola-blue-600 transition-colors text-lg font-medium">
              Find Your Remedy
            </Button>
